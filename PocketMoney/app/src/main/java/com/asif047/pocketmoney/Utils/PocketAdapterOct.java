...
public class PocketAdapterOct extends RecyclerView.Adapter<PocketAdapterOct.ViewHolder>{
    ...
    public PocketAdapterOct(List<Pocket> myDataset, Context context, RecyclerView recyclerView) {
    ...
    @Override
    public PocketAdapterOct.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                          int viewType) {
        // create a new view
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View v = inflater.inflate(R.layout.row_item_oct, parent, false);
        // set the view's size, margins, paddings and layout parameters
        PocketAdapterOct.ViewHolder vh = new PocketAdapterOct.ViewHolder(v);
        return vh;
    }
    ...
    @Override
    public void onBindViewHolder(PocketAdapterOct.ViewHolder holder, final int position) {
