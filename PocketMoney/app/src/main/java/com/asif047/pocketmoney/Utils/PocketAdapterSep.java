...
public class PocketAdapterSep extends RecyclerView.Adapter<PocketAdapterSep.ViewHolder>{
    ...
    public PocketAdapterSep(List<Pocket> myDataset, Context context, RecyclerView recyclerView) {
    ...
    @Override
    public PocketAdapterSep.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                          int viewType) {
        // create a new view
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View v = inflater.inflate(R.layout.row_item_sep, parent, false);
        // set the view's size, margins, paddings and layout parameters
        PocketAdapterSep.ViewHolder vh = new PocketAdapterSep.ViewHolder(v);
        return vh;
    }
    ...
    @Override
    public void onBindViewHolder(PocketAdapterSep.ViewHolder holder, final int position) {
