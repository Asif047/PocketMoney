...
public class PocketAdapterNov extends RecyclerView.Adapter<PocketAdapterNov.ViewHolder>{
    ...
    public PocketAdapterNov(List<Pocket> myDataset, Context context, RecyclerView recyclerView) {
    ...
    @Override
    public PocketAdapterNov.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                          int viewType) {
        // create a new view
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View v = inflater.inflate(R.layout.row_item_nov, parent, false);
        // set the view's size, margins, paddings and layout parameters
        PocketAdapterNov.ViewHolder vh = new PocketAdapterNov.ViewHolder(v);
        return vh;
    }
    ...
    @Override
    public void onBindViewHolder(PocketAdapterNov.ViewHolder holder, final int position) {
