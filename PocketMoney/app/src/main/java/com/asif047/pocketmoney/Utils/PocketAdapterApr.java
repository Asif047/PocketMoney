...
public class PocketAdapterApr extends RecyclerView.Adapter<PocketAdapterApr.ViewHolder>{
    ...
    public PocketAdapterApr(List<Pocket> myDataset, Context context, RecyclerView recyclerView) {
    ...
    @Override
    public PocketAdapterApr.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                          int viewType) {
        // create a new view
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View v = inflater.inflate(R.layout.row_item_april, parent, false);
        // set the view's size, margins, paddings and layout parameters
        PocketAdapterApr.ViewHolder vh = new PocketAdapterApr.ViewHolder(v);
        return vh;
    }
    ...
    @Override
    public void onBindViewHolder(PocketAdapterApr.ViewHolder holder, final int position) {
