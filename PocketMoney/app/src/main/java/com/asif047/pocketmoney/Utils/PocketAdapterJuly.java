...
public class PocketAdapterJuly extends RecyclerView.Adapter<PocketAdapterJuly.ViewHolder>{
    ...
    public PocketAdapterJuly(List<Pocket> myDataset, Context context, RecyclerView recyclerView) {
    ...
    @Override
    public PocketAdapterJuly.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                           int viewType) {
        // create a new view
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View v = inflater.inflate(R.layout.row_item_july, parent, false);
        // set the view's size, margins, paddings and layout parameters
        PocketAdapterJuly.ViewHolder vh = new PocketAdapterJuly.ViewHolder(v);
        return vh;
    }
    ...
    @Override
    public void onBindViewHolder(PocketAdapterJuly.ViewHolder holder, final int position) {
