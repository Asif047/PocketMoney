...
public class PocketAdapterAug extends RecyclerView.Adapter<PocketAdapterAug.ViewHolder>{
    ...
    public PocketAdapterAug(List<Pocket> myDataset, Context context, RecyclerView recyclerView) {
    ...
    @Override
    public PocketAdapterAug.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                          int viewType) {
        // create a new view
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View v = inflater.inflate(R.layout.row_item_aug, parent, false);
        // set the view's size, margins, paddings and layout parameters
        PocketAdapterAug.ViewHolder vh = new PocketAdapterAug.ViewHolder(v);
        return vh;
    }
    ...
    @Override
    public void onBindViewHolder(PocketAdapterAug.ViewHolder holder, final int position) {
