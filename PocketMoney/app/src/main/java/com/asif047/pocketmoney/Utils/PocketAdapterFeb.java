...
public class PocketAdapterFeb extends RecyclerView.Adapter<PocketAdapterFeb.ViewHolder>{
    ...
    public PocketAdapterFeb(List<Pocket> myDataset, Context context, RecyclerView recyclerView) {
    ...
    @Override
    public PocketAdapterFeb.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                          int viewType) {
        // create a new view
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View v = inflater.inflate(R.layout.row_item_february, parent, false);
        // set the view's size, margins, paddings and layout parameters
        PocketAdapterFeb.ViewHolder vh = new PocketAdapterFeb.ViewHolder(v);
        return vh;
    }
    ...
    @Override
    public void onBindViewHolder(PocketAdapterFeb.ViewHolder holder, final int position) {
