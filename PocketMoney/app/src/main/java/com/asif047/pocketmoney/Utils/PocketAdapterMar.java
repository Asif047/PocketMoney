...
public class PocketAdapterMar extends RecyclerView.Adapter<PocketAdapterMar.ViewHolder>{
    ...
    public PocketAdapterMar(List<Pocket> myDataset, Context context, RecyclerView recyclerView) {
    ...
    @Override
    public PocketAdapterMar.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                          int viewType) {
        // create a new view
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View v = inflater.inflate(R.layout.row_item_march, parent, false);
        // set the view's size, margins, paddings and layout parameters
        PocketAdapterMar.ViewHolder vh = new PocketAdapterMar.ViewHolder(v);
        return vh;
    }
    ...
    @Override
    public void onBindViewHolder(PocketAdapterMar.ViewHolder holder, final int position) {
