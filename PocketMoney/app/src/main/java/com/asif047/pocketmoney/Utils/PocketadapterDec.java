...
public class PocketadapterDec extends RecyclerView.Adapter<PocketadapterDec.ViewHolder> {
    ...
    public PocketadapterDec(List<Pocket> myDataset, Context context, RecyclerView recyclerView) {
    ...
    @Override
    public PocketadapterDec.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                          int viewType) {
        // create a new view
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View v = inflater.inflate(R.layout.row_item_dec, parent, false);
        // set the view's size, margins, paddings and layout parameters
        PocketadapterDec.ViewHolder vh = new PocketadapterDec.ViewHolder(v);
        return vh;
    }
    ...
    @Override
    public void onBindViewHolder(PocketadapterDec.ViewHolder holder, final int position) {
