...
public class PocketAdapterJune extends RecyclerView.Adapter<PocketAdapterJune.ViewHolder> {
    ...
    public PocketAdapterJune(List<Pocket> myDataset, Context context, RecyclerView recyclerView) {
    ...
    @Override
    public PocketAdapterJune.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                           int viewType) {
        // create a new view
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View v = inflater.inflate(R.layout.row_item_june, parent, false);
        // set the view's size, margins, paddings and layout parameters
        PocketAdapterJune.ViewHolder vh = new PocketAdapterJune.ViewHolder(v);
        return vh;
    }
    ...
    @Override
    public void onBindViewHolder(PocketAdapterJune.ViewHolder holder, final int position) {
