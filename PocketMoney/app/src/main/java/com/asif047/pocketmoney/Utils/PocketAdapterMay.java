...
public class PocketAdapterMay extends RecyclerView.Adapter<PocketAdapterMay.ViewHolder>{
    ...
    public PocketAdapterMay(List<Pocket> myDataset, Context context, RecyclerView recyclerView) {
    ...
    @Override
    public PocketAdapterMay.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                          int viewType) {
        // create a new view
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View v = inflater.inflate(R.layout.row_item_may, parent, false);
        // set the view's size, margins, paddings and layout parameters
        PocketAdapterMay.ViewHolder vh = new PocketAdapterMay.ViewHolder(v);
        return vh;
    }
    ...
    @Override
    public void onBindViewHolder(PocketAdapterMay.ViewHolder holder, final int position) {
